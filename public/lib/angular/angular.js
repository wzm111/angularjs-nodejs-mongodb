/**
 * @license AngularJS v1.3.0-local+sha.99a2f0a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.99a2f0a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.99a2f0a',    // all of these placeholder strings will be replaced by grunt's
