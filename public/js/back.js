...
angular.module('demoCat', ['ngRoute', 'catRes']).config(['$routeProvider', '$locationProvider', 
...
function mainCole($scope, $routeParams, $http) {
    $scope.formData = {};
    $scope.saveId = {};
    $scope.global = {};
    $scope.dataId = null;
...
function pageShow($scope, $routeParams, $http) {
